...
window.scrollReveal = (function (window) {
  ...
  scrollReveal.prototype = {
    ...
    //  Reset za timer u slucaju greske loada
  ...
  //  Setovanje razmaka
    ...
    //  Style tag koji se moze izbrisati u slucaju iskljucivanja timera i reseta 
    //  U slucaju dodavanja jos CSS fileova - blokira mjesanje 
        if (!this.options.reset) {
          setTimeout(function () {
  ...
  //  Podesavanje pixela 
  //
  //   "move 25px from top" počinje od 'top: -25px' 
...
(function($) {
        ...
        // Podesavanje sadrzaja za elemnte 
